...
contract DigipadStaking is Ownable, ReEntrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
       ...
       uint256 _emergencyWithdrawFees
        ...
        pooldata[365].returnPer = 1300; // 130%
   ...
   function pendingRewards(uint256 _orderId ) external view returns (uint256) {
    ...
    function withdraw(uint256 orderId) external noReentrant{
        ...
        require(balanceOf[msg.sender] > 0 && orderInfo.amount > 0, "insufficient redeemable tokens"); // ITA
